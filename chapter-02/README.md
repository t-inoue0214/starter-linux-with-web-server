...
drwxr-xr-x 3 vscode vscode 4096 May 19 11:44 ..
drwxr-xr-x 2 vscode vscode 4096 May 19 11:44 work
```
...
/home/vscode/practice/chapter-02/access_hard.log
/home/vscode/practice/chapter-02/access_link.log
/home/vscode/practice/chapter-02/work/access_backup.log
...
$ cat output.txt
b0612b172a29                                      ← stdout だけファイルに入っている
```
...
$ ls ~/practice/chapter-02/*.log | xargs wc -l    # 各ログファイルの行数を一括確認
  ...
  15 /home/vscode/practice/chapter-02/access_hard.log
  15 /home/vscode/practice/chapter-02/access_link.log
  45 total
...
root         1  0.0  0.0   2400  1432 ?        Ss   06:13   0:07 /bin/sh
vscode      40  0.0  0.0   2400  1524 ?        Ss   06:13   0:00 /bin/sh
...

$ ps -ef
UID        PID  PPID  C STIME TTY          TIME CMD
root         1     0  0 06:13 ?        00:00:07 /bin/sh
vscode      40     0  0 06:13 ?        00:00:00 /bin/sh
...
```
...
/dev/vda1              59G   23G   33G  41% /vscode
```
...
Mem:           7.7Gi       1.9Gi       3.7Gi       620Ki       2.3Gi       5.8Gi
Swap:          1.0Gi          0B       1.0Gi
```
...
Linux b0612b172a29 6.12.76-linuxkit #1 SMP Thu Apr 30 11:19:05 UTC 2026 aarch64 GNU/Linux
```
...
1. `cat access.log | grep 'ERROR' | wc -l` というコマンドは何をするか説明せよ。
...
1. `command > output.txt 2>&1` はどのような動作をするか? `command > output.txt` との違いを説明せよ。
...
1. コマンドの出力をファイルに保存しながら、同時に画面にも表示させたい。どうするか?
...
1. `ps aux` でプロセスを確認し、`sleep 100` というプロセスを終了させる手順を説明せよ。
